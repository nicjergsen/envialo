    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Asignar encomienda a un sector de la bodega(1/2)</li>
            </ol>
            <h2>Asignar encomienda a un sector de la bodega(1/2)</h2>
        </div>
        <div class="col-lg-6">
            <form method="POST" action="{{ url("bodega/new ")}}">
                {{ csrf_field() }}
